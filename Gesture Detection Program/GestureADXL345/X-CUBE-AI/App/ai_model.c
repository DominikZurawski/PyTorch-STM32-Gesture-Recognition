...
#define AI_NET_OBJ_INSTANCE g_ai_model
 
#undef AI_AI_MODEL_MODEL_SIGNATURE
#define AI_AI_MODEL_MODEL_SIGNATURE     "0x980e341e6258903324e2a83ac05569b2"
...
#define AI_TOOLS_DATE_TIME   "2025-07-22T19:58:31+0200"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_AI_MODEL_N_BATCHES
#define AI_AI_MODEL_N_BATCHES         (1)

static ai_ptr g_ai_model_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_ai_model_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_ARRAY_OBJ_DECLARE(
  accelerometer_data_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 240, AI_STATIC)

/* Array#1 */
AI_ARRAY_OBJ_DECLARE(
  accelerometer_data_Transpose_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 240, AI_STATIC)
...
/* Array#7 */
AI_ARRAY_OBJ_DECLARE(
  gesture_prediction_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Array#16 */
AI_ARRAY_OBJ_DECLARE(
  gesture_prediction_weights_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 512, AI_STATIC)

/* Array#17 */
AI_ARRAY_OBJ_DECLARE(
  gesture_prediction_bias_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 8, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x0,
  AI_SHAPE_INIT(4, 3, 1, 3, 32), AI_STRIDE_INIT(4, 4, 12, 384, 384),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 1, 128, 1, 10), AI_STRIDE_INIT(4, 4, 4, 512, 512),
  1, &_conv3_Conv_output_0_output_array, NULL)

/* Tensor #12 */
AI_TENSOR_OBJ_DECLARE(
  _conv3_Conv_output_0_output0, AI_STATIC,
  12, 0x0,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  18, 0x0,
  AI_SHAPE_INIT(4, 1280, 64, 1, 1), AI_STRIDE_INIT(4, 4, 5120, 327680, 327680),
...
/* Tensor #20 */
AI_TENSOR_OBJ_DECLARE(
  accelerometer_data_Transpose_output, AI_STATIC,
  20, 0x0,
  AI_SHAPE_INIT(4, 1, 3, 1, 80), AI_STRIDE_INIT(4, 4, 4, 12, 12),
  1, &accelerometer_data_Transpose_output_array, NULL)

/* Tensor #21 */
AI_TENSOR_OBJ_DECLARE(
  accelerometer_data_output, AI_STATIC,
  21, 0x0,
  AI_SHAPE_INIT(4, 1, 80, 1, 3), AI_STRIDE_INIT(4, 4, 4, 320, 320),
  1, &accelerometer_data_output_array, NULL)

/* Tensor #22 */
AI_TENSOR_OBJ_DECLARE(
  gesture_prediction_bias, AI_STATIC,
  22, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 1), AI_STRIDE_INIT(4, 4, 4, 32, 32),
  1, &gesture_prediction_bias_array, NULL)

/* Tensor #23 */
AI_TENSOR_OBJ_DECLARE(
  gesture_prediction_output, AI_STATIC,
  23, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 1), AI_STRIDE_INIT(4, 4, 4, 32, 32),
  1, &gesture_prediction_output_array, NULL)

/* Tensor #24 */
AI_TENSOR_OBJ_DECLARE(
  gesture_prediction_weights, AI_STATIC,
  24, 0x0,
  AI_SHAPE_INIT(4, 64, 8, 1, 1), AI_STRIDE_INIT(4, 4, 256, 2048, 2048),
  1, &gesture_prediction_weights_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  gesture_prediction_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_relu_3_Relu_output_0_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &gesture_prediction_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 2, &gesture_prediction_weights, &gesture_prediction_bias),
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  gesture_prediction_layer, 13,
  DENSE_TYPE, 0x0, NULL,
  dense, forward_dense,
  &gesture_prediction_chain,
  NULL, &gesture_prediction_layer, AI_STATIC, 
)
...
AI_LAYER_OBJ_DECLARE(
  _relu_3_Relu_output_0_layer, 12,
  NL_TYPE, 0x0, NULL,
  nl, forward_relu,
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_conv3_Conv_output_0_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_fc1_Gemm_output_0_output),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &accelerometer_data_Transpose_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_conv1_Conv_output_0_output),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  accelerometer_data_Transpose_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &accelerometer_data_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &accelerometer_data_Transpose_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_LAYER_OBJ_DECLARE(
  accelerometer_data_Transpose_layer, 2,
  TRANSPOSE_TYPE, 0x0, NULL,
  transpose, forward_transpose,
  &accelerometer_data_Transpose_chain,
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 454944, 1, 1),
    454944, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 8704, 1, 1),
    8704, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_AI_MODEL_IN_NUM, &accelerometer_data_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_AI_MODEL_OUT_NUM, &gesture_prediction_output),
  &accelerometer_data_Transpose_layer, 0x597f0881, NULL)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_AI_MODEL_MODEL_NAME,
      .model_signature   = AI_AI_MODEL_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_bool ai_ai_model_get_report(
  ai_handle network, ai_network_report* report)
{
  ai_network* net_ctx = AI_NETWORK_ACQUIRE_CTX(network);
...
AI_API_ENTRY
ai_handle ai_ai_model_destroy(ai_handle network)
{
...
AI_API_ENTRY
ai_i32 ai_ai_model_forward(ai_handle network, const ai_buffer* input)
{
