/**
  ...
  ******************************************************************************
  */
#ifndef AI_AI_MODEL_H
#define AI_AI_MODEL_H

#include "ai_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_AI_MODEL_MODEL_NAME          "ai_model"
#define AI_AI_MODEL_ORIGIN_MODEL_NAME   "gesture_model"

/******************************************************************************/
#define AI_AI_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_AI_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_AI_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_AI_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_AI_MODEL_IN \
  ai_ai_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_AI_MODEL_IN_SIZE { \
  AI_AI_MODEL_IN_1_SIZE, \
}
#define AI_AI_MODEL_IN_SIZE_BYTES { \
  AI_AI_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_AI_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_AI_MODEL_IN_1_HEIGHT      (80)
#define AI_AI_MODEL_IN_1_CHANNEL     (3)
#define AI_AI_MODEL_IN_1_SIZE        (240)
#define AI_AI_MODEL_IN_1_SIZE_BYTES  (960)

/******************************************************************************/
#define AI_AI_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_AI_MODEL_OUT \
  ai_ai_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_AI_MODEL_OUT_SIZE { \
  AI_AI_MODEL_OUT_1_SIZE, \
}
#define AI_AI_MODEL_OUT_SIZE_BYTES { \
  AI_AI_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_AI_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_AI_MODEL_OUT_1_CHANNEL     (8)
#define AI_AI_MODEL_OUT_1_SIZE        (8)
#define AI_AI_MODEL_OUT_1_SIZE_BYTES  (32)

/******************************************************************************/
#define AI_AI_MODEL_N_NODES (7)
 ...
 * @ref ai_ai_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_ai_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ai_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ai_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_AI_MODEL_*
 * defines into file @ref ai_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
